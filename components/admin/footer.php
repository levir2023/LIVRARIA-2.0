    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <p class="mb-1"><i class="fas fa-envelope-open-text"></i> <a href="mailto:contato@chefemcasa.com" class="text-light">contato@obrasdavida.com</a></p>
        ...
        <div class="row mt-4">
            <div class="col text-center">
                <p class="text-light">Feito pela equipe da obras da vida.</p>
            </div>
        </div>
    </div>
</footer>
