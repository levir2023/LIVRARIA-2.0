...
<head>
  ...
  <?php
    ...
    if (isset($pageInfo)) {
        ...
        echo "<title>Livraria Obras da Vida</title>";
        echo "<meta name='description' content='Bem-vindo ao Livraria Obras da Vida'>";
    }
    ?>
</head>
  ...
  <nav class="navbar navbar-expand-lg navbar-light">
    <div class="container">
      <a class="navbar-brand" href="index.php">
        <img src="src/img/logo.png" alt="Logo Livraria Obras da Vida" class="w-25">
      </a>
