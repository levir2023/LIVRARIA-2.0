...
<main class="container my-5">
    <div class="row">
        <div class="col-md-6">
            <h1 class="mb-4">Sobre o Livraria Obras da Vida</h1>
            <p>
                Bem-vindo ao Livraria Obras da Vida, o lugar onde a paixão pela culinária se encontra com a comunidade online. 
        ...
        <div class="col-md-6">
            <img src="src/img/logo.png" alt="Imagem Sobre o Livraria Obras da Vida" class="img-fluid rounded">
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-4 mb-4">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <p class="card-text">Livraria Obras da Vida firma parceria para promover a culinária em comunidades locais.</p>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-4 mb-4">
            <div class="card">
                <img src="src/img/news2.jpg" class="card-img-top" alt="Livraria Obras da Vida na Mídia">
                <div class="card-body">
                    <h5 class="card-title">Livraria Obras da Vida na Mídia</h5>
                    <p class="card-text">Veja como o Livraria Obras da Vida está ganhando destaque nos principais veículos de comunicação.</p>
                </div>
            </div>
        </div>
